                    ...
                    <div class="col-12">
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                    ...
                                                    <td>{{$row->status}}</td>                                                
                                                    <td>
                                                            <a class="btn btn-primary" href="/edit-jual">edit</a> &nbsp;
                                                            <a type="button" class="btn btn-danger" href="{{ url('/Penjualan/delete/'.$row->id_penjualan)}}">hapus</a>
                                                    </td>                                                
                                                </tr>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-2 ml-auto">
                                <a href="/tambah-jual" type="submit" class="btn btn-primary">Tambah Data Baru</a>
