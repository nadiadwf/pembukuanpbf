                        ...
                        <div class="col-12">
                                        ...
                                        <table class="table table-striped table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                             ...
                                             <tr>
                                                 ...
                                                 <td>
                                                     <a class="btn btn-primary" href="{{ route('Kas.edit', ['Kas' => $row->id_kas]) }}">edit</a> &nbsp;                                
                                                     <a class="btn btn-danger" href="#" onclick="hapus(event, '{{ route('Kas.destroy', ['Kas' => $row->id_kas]) }}')">hapus</a>
                                                 </td>
                                             </tr>
                                             @endforeach
                                         </tbody>
                         ...
                         <div class="form-group row">
                            <div class="col-lg-2 ml-auto">
                                <a href="{{ route('Kas.create') }}" class="btn btn-primary">Tambah Data Baru</a>
