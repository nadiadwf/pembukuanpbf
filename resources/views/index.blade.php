                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h2>Sistem Pembukuan / Framework C </h2>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h5 class="mt-3 mb-1">Almas Najla</h5>
                                    <p class="m-0">162410101039</p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h5 class="mt-3 mb-1">Moch Regy Pangestu</h5>
                                    <p class="m-0">162410101045</p>
                                    <!-- <a href="javascript:void()" class="btn btn-sm btn-warning">Send Message</a> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h5 class="mt-3 mb-1">Zandhytama H A</h5>
                                    <p class="m-0">162410101062</p>
                                    <!-- <a href="javascript:void()" class="btn btn-sm btn-warning">Send Message</a> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    ...
                                    <h5 class="mt-3 mb-1">Isyatun Haniyah</h5>
                                    <p class="m-0">162410101087</p>
                                    <!-- <a href="javascript:void()" class="btn btn-sm btn-warning">Send Message</a> -->
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="text-center">
                                        ...
                                        <h5 class="mt-3 mb-1">Nadia Dwi Fatmawati</h5>
                                        <p class="m-0">162410101088</p>
                                        <!-- <a href="javascript:void()" class="btn btn-sm btn-warning">Send Message</a> -->
                                    </div>
                                </div>
                            </div>
