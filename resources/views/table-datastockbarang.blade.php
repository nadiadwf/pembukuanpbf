                    ...
                    <div class="col-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->namabarang }}</td>
                                                 ...
                                                 <td>
                                                     <a class="btn btn-primary" href="{{ route('stok.edit', ['stok' => $row->id_barang]) }}">edit</a> &nbsp;       
                                                     <a eclass="btn btn-danger" href="#" onclick="hapus(event, '{{ route('stok.destroy', ['stok' => $row->id_barang]) }}')">hapus</a>
                                                 </td>
                                            </tr>
                                            @endforeach 
                                        </tbody>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-2 ml-auto">
                                 <a href="{{ route('stok.create') }}" type="submit" class="btn btn-primary">Tambah Data Baru</a>
