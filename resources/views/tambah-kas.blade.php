                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form role ="form" action="{{ route('Kas.store') }}" method="post">
                                        @csrf
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="debet">Debet <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input value="{{ old('debet') }}" type="text" class="form-control" id="debet" name="debet" placeholder="Rp..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ old('kredit') }}" type="text" class="form-control" id="kredit" name="kredit" placeholder="Rp..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ old('keterangan') }}" type="text" class="form-control" id="keterangan" name="keterangan" placeholder="kasih keterangan w">
