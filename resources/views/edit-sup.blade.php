                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('Supplier.update', ['Supplier' => $supplier->id_supplier]) }}" method="post">
                                        @csrf
                                        {{method_field('PUT')}}
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ $supplier->namasupp }}" type="text" class="form-control" id="namasupp"   name="namasupp" placeholder="Nama Supplier..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ $supplier->alamat}}" type="text" class="form-control" id="alamat" name="alamat" required placeholder="Alamat Supplier..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ $supplier->nohp }}" type="text" class="form-control" id="nohp" name="nohp" required placeholder="082..">
