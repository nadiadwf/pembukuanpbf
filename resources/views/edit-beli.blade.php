                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('pembeli.store') }}" method="post">
                                        @csrf
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="date">Tanggal <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="date" value="{{ old('tanggal') }}" class="form-control" id="date" name="tanggal" placeholder="17 Agustus..">
                                            </div>
                                              @error('tanggal')
                                                {{ $message }}
                                                @enderror
                                            ...
                                            <div class="col-lg-6">
                                                <select  id="namabarang" name="barang" class="form-control">
                                                   <?php foreach ($barangs as $br): ?>
                                                        <option value="{{$br->id_barang}}">{{$br->namabarang}}</option>
                                                   <?php endforeach ?>
                                                </select>
                                                 @error('barang')
                                                {{ $message }}
                                            ...
                                            <div class="col-lg-6">
                                                 <select id="namabarang" name="supplier" class="form-control">
                                                   <?php foreach ($suppliers as $sp): ?>
                                                        <option value="{{$sp->id_supplier}}">{{$sp->namasupp}}</option>
                                                   <?php endforeach ?>
                                                </select>
                                                 @error('supplier')
                                                {{ $message }}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="number" value="{{ old('jumlah') }}" class="form-control" id="jumlah" name="jumlah" placeholder="isikan Jumlah ...">
                                                 @error('jumlah')
                                                {{ $message }}
                                                @enderror
                                            </div>
