                    ...
                    <div class="col-12">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $row->namasupp }}</td>
                                                 ...
                                                 <td>{{ $row->nohp }} </td>
                                                 <td>
                                                     <a class="btn btn-primary" href="{{ route('Supplier.edit', ['Supplier' => $row->id_supplier]) }}">edit</a> &nbsp;                                
                                                     <a eclass="btn btn-danger" href="#" onclick="hapus(event, '{{ route('Supplier.destroy', ['Supplier' => $row->id_supplier]) }}')">hapus</a>
                                                 </td>
                                            </tr>
                                            @endforeach        
                                        </tbody>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-2 ml-auto">
                                <a href="{{ route('Supplier.create') }}" type="submit" class="btn btn-primary">Tambah Data Baru</a>
