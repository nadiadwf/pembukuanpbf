                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="{{ route('stok.store') }}" method="post">
                                        @csrf
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="namabarang">Nama Barang <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input value="{{ old('namabarang') }}" type="text" class="form-control" id="namabarang"   name="namabarang" placeholder="Nama Barang..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ old('jumlah') }}" type="text" class="form-control" id="jumlah" name="jumlah" required placeholder="Jumlah Barang..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ old('harga') }}" type="text" class="form-control" id="harga" name="harga" required placeholder="Rp..">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                               <select class="form-control" name="supplier">
                                                   ...
                                                   <option value="{{$row->id_supplier}}">{{$row->namasupp}}</option>
                                                   @endforeach
                                               </select>
