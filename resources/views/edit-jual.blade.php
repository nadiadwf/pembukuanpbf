                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="{{route('addpenjualan')}}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ $penjualan->created_at}} type="date" class="form-control" id="tanggal" name="tanggal">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <option value="{{ $penjualan->namabarang}}">{{$barang->namabarang}}</option>
                                                    @foreach ($barang as $b)
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input value="{{ $penjualan->jumlah}}" type="number" class="form-control" id="jumlah" name="jumlah" placeholder="jumlah">
                                            </div>
                                        </div>
                                        <div class="form-group row">
